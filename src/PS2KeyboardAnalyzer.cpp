...
PS2KeyboardAnalyzer::PS2KeyboardAnalyzer() : Analyzer2(), mSettings( new PS2KeyboardAnalyzerSettings() ), mSimulationInitilized( false )
{
        ...
        if( DeviceTx )
        {
            ...
            else
            {
                ...
                else if( DataPayload & 0x08 )
                {
                    ...
                    DataPayload =
                        movement_packet[ 3 ] << 24 | movement_packet[ 2 ] << 16 | movement_packet[ 1 ] << 8 | movement_packet[ 0 ];
                }
                else
                {
                }
...
U32 PS2KeyboardAnalyzer::GenerateSimulationData( U64 minimum_sample_index, U32 device_sample_rate,
